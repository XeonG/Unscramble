...
public class CommandHelp
{
  public static void help(Player p)
  {
    ...
    p.sendMessage("§c/unscramble §7setScrambleSeparately [true/false] §e- Sets scramble-words-seperatly value in config file");
  ...
  public static void help(CommandSender p)
  {
    ...
    p.sendMessage("/unscramble setScrambleSeparately [true/false] - Sets scramble-words-seperatly value in config file");
